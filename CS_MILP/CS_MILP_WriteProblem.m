function CS_MILP_WriteProblem(fileID, A, b, fileTypeFlag)
% CS_MILP_WriteProblem(fileID, A, b, fileTypeFlag)
% Write problem to files
% Input Arguments:
% fileID       : 
% A            : Constraint Matrix
% b            : RHS Vector
% fileTypeFlag : 0 for L0 norm & 1 for L1 norm

[rank, dimension] = size(A);
...
elseif fileTypeFlag == 1 % L1_file generation
